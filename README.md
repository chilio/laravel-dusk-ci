...
Versions: [![](https://img.shields.io/static/v1?label=&message=php-8.4&color=green)](https://hub.docker.com/r/chilio/laravel-dusk-ci/tags/)
[![](https://img.shields.io/static/v1?label=&message=php-8.3&color=green)](https://hub.docker.com/r/chilio/laravel-dusk-ci/tags/)
[![](https://img.shields.io/static/v1?label=&message=php-8.2&color=yellow)](https://hub.docker.com/r/chilio/laravel-dusk-ci/tags/)
...
**Laravel dusk**? Find more in Laravel Dusk Docs [12.x](https://laravel.com/docs/12.x/dusk) | [11.x](https://laravel.com/docs/11.x/dusk) | [10.x](https://laravel.com/docs/10.x/dusk) | [9.x](https://laravel.com/docs/9.x/dusk) | [8.x](https://laravel.com/docs/8.x/dusk) | [7.x](https://laravel.com/docs/7.x/dusk) | [6.x](https://laravel.com/docs/6.x/dusk) | [5.8](https://laravel.com/docs/5.8/dusk)
...
| 6.x             | YES        | [![](https://img.shields.io/static/v1?label=&message=php-8.0&color=red)](https://hub.docker.com/r/chilio/laravel-dusk-ci/tags/) [![](https://img.shields.io/static/v1?label=&message=php-7.4&color=red)](https://hub.docker.com/r/chilio/laravel-dusk-ci/tags/) [![](https://img.shields.io/static/v1?label=&message=php-7.3&color=red)](https://hub.docker.com/r/chilio/laravel-dusk-ci/tags/) [![](https://img.shields.io/static/v1?label=&message=php-7.2&color=red)](https://hub.docker.com/r/chilio/laravel-dusk-ci/tags/)    |
| 5.8             | YES        | [![](https://img.shields.io/static/v1?label=&message=php-7.2&color=red)](https://hub.docker.com/r/chilio/laravel-dusk-ci/tags/) [![](https://img.shields.io/static/v1?label=&message=php-7.1&color=red)](https://hub.docker.com/r/chilio/laravel-dusk-ci/tags/)                                                                                                                                                                                                                                                                    |
| 5.7             | YES        | [![](https://img.shields.io/static/v1?label=&message=php-7.1&color=red)](https://hub.docker.com/r/chilio/laravel-dusk-ci/tags/)                                                                                                                                                                                                                                                                  |
| 5.6             | YES        | [![](https://img.shields.io/static/v1?label=&message=php-7.1&color=red)](https://hub.docker.com/r/chilio/laravel-dusk-ci/tags/)                                                                                                                                                                                                                                                                                                                                                                                                    |
| 5.5             | YES        | [![](https://img.shields.io/static/v1?label=&message=old-stable&color=red)](https://hub.docker.com/r/chilio/laravel-dusk-ci/tags/)                                                                                                                                                                                                                                                                                                                                                                                                 |
...
- 2025-03-15 - `start-system-chromedriver`, `start-project-chromedriver`, `stop-chromedriver` commands introduced
- 2025-03-14 - new images built on ubuntu 24.04 noble. If you experience any problems you can use legacy images with tag `php-x.y-legacy` where x is the php x.y version you need. 
